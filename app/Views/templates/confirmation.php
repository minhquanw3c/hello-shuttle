...
<head>
    ...
    <!-- Font Icons css -->
    <link rel="stylesheet" href="<?= base_url('autixir/css/font-icons.css') ?>">
    <!-- plugins css -->
    <link rel="stylesheet" href="<?= base_url('autixir/css/plugins.css') ?>">
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="<?= base_url('autixir/css/style.css') ?>">
    <!-- Responsive css -->
    <link rel="stylesheet" href="<?= base_url('autixir/css/responsive.css') ?>">
</head>
                ...
                <div class="row">
                    <div class="col">
                        <div class="site-logo-wrap">
                            <div class="site-logo">
                                <a href="<?= base_url('/') ?>"><img src="<?= base_url('autixir/img/logo-2.png') ?>" alt="Logo"></a>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            <h1 class="section-title white-color">Booking confirmation</h1>
                        </div>
