...
<script type="text/javascript">
    ...
    const apiKey = "<?= $enviroment === 'production' ? $_SERVER['GOOGLE_MAP_API_KEY_PROD'] : $_SERVER['GOOGLE_MAP_API_KEY_LOCALHOST'] ?>";
</script>
...
<?php else: ?>
    <script
        defer
        src=<?= "https://maps.googleapis.com/maps/api/js?key=" . $_SERVER['GOOGLE_MAP_API_KEY_LOCALHOST'] . "&libraries=places&callback=initMap" ?>>
    </script>
<?php endif ?>
